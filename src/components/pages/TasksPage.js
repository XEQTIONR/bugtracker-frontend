    ...
    <Page speed={props.speed} sidebarState={props.sidebarState}>
        ...
        <div className="row mx-2 mt-4">
          <div className="col-12">
            <h1 className="ml-1">TasksPage</h1>
            <h5 className="ml-1 text-muted">Your Tasks</h5>
          </div>
        </div>
        <div className="row mx-2">
          <div className="col-md-3">
            {/* <Button label="Create a new Issue" buttonClasses="btn btn-success btn-sm" /> */}
            <div className="row">
              <div className="col-12">
            ...
            <div className="row">
              ...
              <div className="col-12 mt-4">
                ...
                <div class="user-block mt-1">
                  <img class="img-circle img-bordered-sm" src="https://www.pngitem.com/pimgs/m/78-786293_1240-x-1240-0-avatar-profile-icon-png.png" alt="User Image" />
                  <span class="username mt-1">
                    <a href="#">Sarah Ross</a>
